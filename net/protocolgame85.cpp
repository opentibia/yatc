...
ProtocolGame85::~ProtocolGame85()
{
	//
}

void ProtocolGame85::checkVersion()
{
	ASSERT(ProtocolConfig::getInstance().getClientVersion() == CLIENT_VERSION_850);
}
...
bool ProtocolGame85::parsePacket(uint8_t cmd, NetworkMessage& msg)
{
...
bool ProtocolGame85::parseTileAddThing(NetworkMessage& msg)
{
