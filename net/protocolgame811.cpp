...
bool ProtocolGame811::onRecv(NetworkMessage& msg)
{
	m_currentMsg = &msg;
	m_currentMsgN++;
	while(!msg.eof()){
...
bool ProtocolGame811::setMapDescription(NetworkMessage& msg, int x, int y, int z, int width, int height)
{
...
bool ProtocolGame811::setFloorDescription(NetworkMessage& msg, int x, int y, int z, int width, int height, int offset)
{
...
bool ProtocolGame811::setTileDescription(NetworkMessage& msg, const Position& pos)
{
...
Thing* ProtocolGame811::internalGetThing(NetworkMessage& msg)
{
	//get thing type
...
Item* ProtocolGame811::internalGetItem(NetworkMessage& msg, uint32_t itemid)
{
...
bool ProtocolGame811::internalSetOutfit(NetworkMessage& msg, Outfit_t& outfit)
{
...
//******send functions***********
//public
void ProtocolGame811::sendLogout()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x14);
}

void ProtocolGame811::sendAutoWalk(const std::list<Direction>& steps)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendStopAutoWalk()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x69);
}

void ProtocolGame811::sendMove(Direction dir)
{
	PROTOCOLGAME_SEND_FUNCTION;
	switch(dir){
...
void ProtocolGame811::sendTurn(Direction dir)
{
	PROTOCOLGAME_SEND_FUNCTION;
	switch(dir){
	case DIRECTION_NORTH:
...
void ProtocolGame811::sendThrow(const Position& fromPos, uint16_t itemid,
...
void ProtocolGame811::sendRequestTrade(const Position& pos, uint16_t itemid,
...
void ProtocolGame811::sendLookInTrade(bool inMyOffer, uint8_t index)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendAcceptTrade()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x7F);
}

void ProtocolGame811::sendRejectTrade()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x80);
}

void ProtocolGame811::sendUseItem(const Position& pos, uint16_t itemid,
			uint8_t stackpos)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendUseItemWith(const Position& fromPos, uint16_t fromItemid,
...
void ProtocolGame811::sendUseBattleWindow(const Position& pos, uint16_t itemid,
...
void ProtocolGame811::sendRotateItem(const Position& pos, uint16_t itemid,
			uint8_t stackpos)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendCloseContainer(uint8_t containerIndex)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendUpContainer(uint8_t containerIndex)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendTextWindow(uint32_t windowId, const std::string& text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendHouseWindow(uint32_t windowId, int unk,
...
void ProtocolGame811::sendLookItem(const Position& pos, uint16_t itemid,
			uint8_t stackpos)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendSay(SpeakClasses_t type, const std::string text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendSay(SpeakClasses_t type, uint16_t channel,
			const std::string text)
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x96);
...
void ProtocolGame811::sendSay(SpeakClasses_t type, const std::string& sendToplayer,
			const std::string text)
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x96);
...
void ProtocolGame811::sendRequestChannels()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x97);
}

void ProtocolGame811::sendOpenChannel(uint16_t channelid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendCloseChannel(uint16_t channelid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendOpenPrivatePlayerChat(const std::string& playerName)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendOpenRuleViolation(const std::string& text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendCloseRuleViolation(const std::string& text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendCancelRuleViolation()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x9D);
}

void ProtocolGame811::sendFightModes(uint8_t attack, uint8_t chase, uint8_t secure)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendAttackCreature(uint32_t creatureid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendFollowCreature(uint32_t creatureid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendCreatePrivateChatChannel()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0xAA);
}

void ProtocolGame811::sendInvitePrivateChatChannel(const std::string& name)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendExcludePrivateChatChannel(const std::string& name)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendInviteParty(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendJoinParty(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendCancelInviteParty(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendPassParyLeader(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendLeaveParty()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0xA7);
}

void ProtocolGame811::sendCancelMove()
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendRequestOutfit()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0xD2);
}

void ProtocolGame811::sendSetOutfit(uint16_t looktype, uint8_t head, uint8_t body,
...
void ProtocolGame811::sendAddVip(const std::string& name)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendRemVip(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendBugReport(const std::string& text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendRequestQuestLog()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0xF0);
}

void ProtocolGame811::sendRequestQuest(uint16_t questid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
//protected
void ProtocolGame811::sendPing()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x1E);
}

void ProtocolGame811::sendRequestUpdateTile(const Position& pos)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame811::sendRequestUpdateContainer(uint8_t containerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
