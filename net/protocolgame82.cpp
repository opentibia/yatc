...
bool ProtocolGame82::setMapDescription(NetworkMessage& msg, int x, int y, int z, int width, int height)
{
...
bool ProtocolGame82::setFloorDescription(NetworkMessage& msg, int x, int y, int z, int width, int height, int offset)
{
...
bool ProtocolGame82::setTileDescription(NetworkMessage& msg, const Position& pos)
{
