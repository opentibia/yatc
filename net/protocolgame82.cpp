...
bool ProtocolGame82::onRecv(NetworkMessage& msg)
{
	...
	while(!msg.eof()){
		...
		{
		    ASSERTFRIENDLY("Packet 0x0A should have been handled elsewhere.", false);
			break;
		}
		case 0x0B: //GM actions
		{
			ASSERTFRIENDLY("Packet 0x0B should have been handled elsewhere.", false);
			break;
		}
		case 0x14: //Error message
		{
            ASSERTFRIENDLY("Packet 0x14 should have been handled elsewhere.", false);
			break;
		}
		case 0x15: //For your information message
		{
            ASSERTFRIENDLY("Packet 0x15 should have been handled elsewhere.", false);
			break;
		}
		case 0x16: //Waiting list
		{
            ASSERTFRIENDLY("Packet 0x16 should have been handled elsewhere.", false);
			break;
		}
		case 0x1E: //ping
		{
			ASSERTFRIENDLY("Packet 0x1E should have been handled elsewhere.", false);
			break;
		}
		case 0x28: //Relogin window -- this happens when you die
		{
		    ASSERTFRIENDLY("Packet 0x28 should have been handled elsewhere.", false);
			break;
		}
		case 0x32: //Can report bugs
		{
		    ASSERTFRIENDLY("Packet 0x32 should have been handled elsewhere.", false);
		    break;
		}
		case 0x64: //Map description
		{
		    ASSERTFRIENDLY("Packet 0x64 should have been handled elsewhere.", false);
			break;
		}
		case 0x65: //move north
		{
			ASSERTFRIENDLY("Packet 0x65 should have been handled elsewhere.", false);
			break;
		}
		case 0x66: //move east
		{
			ASSERTFRIENDLY("Packet 0x66 should have been handled elsewhere.", false);
			break;
		}
		case 0x67: //move south
		{
		    ASSERTFRIENDLY("Packet 0x67 should have been handled elsewhere.", false);
			break;
		}
		case 0x68: //move west
		{
		    ASSERTFRIENDLY("Packet 0x68 should have been handled elsewhere.", false);
			break;
		}
		case 0x69: //update tile
		{
            ASSERTFRIENDLY("Packet 0x69 should have been handled elsewhere.", false);
			break;
		}
		case 0x6A: //tile - add thing
		{
            ASSERTFRIENDLY("Packet 0x6A should have been handled elsewhere.", false);
			break;
		}
		case 0x6B: //tile transform thing or creature turn
		{
			ASSERTFRIENDLY("Packet 0x6B should have been handled elsewhere.", false);
			break;
		}
		case 0x6C: //tile - remove thing
		{
			ASSERTFRIENDLY("Packet 0x6C should have been handled elsewhere.", false);
			break;
		}
		case 0x6D: //creature move
		{
			ASSERTFRIENDLY("Packet 0x6D should have been handled elsewhere.", false);
			break;
		}
		case 0x6E: //open container
		{
            ASSERTFRIENDLY("Packet 0x6E should have been handled elsewhere.", false);
			break;
		}
		case 0x6F: //close container
		{
		    ASSERTFRIENDLY("Packet 0x6F should have been handled elsewhere.", false);
			break;
		}
		case 0x70: //container - add item
		{
		    ASSERTFRIENDLY("Packet 0x70 should have been handled elsewhere.", false);
			break;
		}
		case 0x71: //container - update item
		{
		    ASSERTFRIENDLY("Packet 0x71 should have been handled elsewhere.", false);
			break;
		}
		case 0x72: //container - remove item
		{
		    ASSERTFRIENDLY("Packet 0x72 should have been handled elsewhere.", false);
			break;
		}
		case 0x78: //inventory set slot item
		{
		    ASSERTFRIENDLY("Packet 0x73 should have been handled elsewhere.", false);
			break;
		}
		case 0x79: //inventory reset slot
		{
		    ASSERTFRIENDLY("Packet 0x79 should have been handled elsewhere.", false);
			break;
		}
		...
		{
		    ASSERTFRIENDLY("Packet 0x7D or 0x7E should have been handled elsewhere.", false);
			break;
		}
		case 0x7F: //close trade
		{
		    ASSERTFRIENDLY("Packet 0x7F should have been handled elsewhere.", false);
			break;
		}

		case 0x82: //gameworld light-settings
		{
		    ASSERTFRIENDLY("Packet 0x82 should have been handled elsewhere.", false);
			break;
		}
		case 0x83: //magic effect
		{
		    ASSERTFRIENDLY("Packet 0x83 should have been handled elsewhere.", false);
			break;
		}
		case 0x84: //animated text
		{
		    ASSERTFRIENDLY("Packet 0x84 should have been handled elsewhere.", false);
			break;
		}
		case 0x85: //distance shot
		{
		    ASSERTFRIENDLY("Packet 0x85 should have been handled elsewhere.", false);
		    break;
		}
		case 0x86: //creature - square
		{
            ASSERTFRIENDLY("Packet 0x86 should have been handled elsewhere.", false);
			break;
		}
		case 0x8C: //creature - health
		{
		    ASSERTFRIENDLY("Packet 0x8C should have been handled elsewhere.", false);
			break;
		}
		case 0x8D: //creature - light level
		{
		    ASSERTFRIENDLY("Packet 0x8D should have been handled elsewhere.", false);
			break;
		}
		case 0x8E: //creature - outfit
		{
            ASSERTFRIENDLY("Packet 0x8E should have been handled elsewhere.", false);
			break;
		}
		case 0x8F: //creature - change speed
		{
		    ASSERTFRIENDLY("Packet 0x8F should have been handled elsewhere.", false);
			break;
		}
		case 0x90: //creature - skulls
		{
		    ASSERTFRIENDLY("Packet 0x90 should have been handled elsewhere.", false);
			break;
		}
		case 0x91: //creature - shields
		{
		    ASSERTFRIENDLY("Packet 0x91 should have been handled elsewhere.", false);
			break;
		}
		case 0x96: //text window
		{
		    ASSERTFRIENDLY("Packet 0x96 should have been handled elsewhere.", false);
			break;
		}
