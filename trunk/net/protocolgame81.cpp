...
ProtocolGame81::~ProtocolGame81()
{
	//
}

bool ProtocolGame81::onRecv(NetworkMessage& msg)
{
	m_currentMsg = &msg;
	m_currentMsgN++;
	while(!msg.eof()){
...
bool ProtocolGame81::setMapDescription(NetworkMessage& msg, int x, int y, int z, int width, int height)
{
...
bool ProtocolGame81::setFloorDescription(NetworkMessage& msg, int x, int y, int z, int width, int height, int offset)
{
...
bool ProtocolGame81::setTileDescription(NetworkMessage& msg, const Position& pos)
{
...
Thing* ProtocolGame81::internalGetThing(NetworkMessage& msg)
{
	//get thing type
...
Item* ProtocolGame81::internalGetItem(NetworkMessage& msg, uint32_t itemid)
{
...
bool ProtocolGame81::internalSetOutfit(NetworkMessage& msg, Outfit_t& outfit)
{
...
//******send functions***********
//public
void ProtocolGame81::sendLogout()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x14);
}

void ProtocolGame81::sendAutoWalk(const std::list<Direction>& steps)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendStopAutoWalk()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x69);
}

void ProtocolGame81::sendMove(Direction dir)
{
	PROTOCOLGAME_SEND_FUNCTION;
	switch(dir){
...
void ProtocolGame81::sendTurn(Direction dir)
{
	PROTOCOLGAME_SEND_FUNCTION;
	switch(dir){
	case DIRECTION_NORTH:
...
void ProtocolGame81::sendThrow(const Position& fromPos, uint16_t itemid,
...
void ProtocolGame81::sendRequestTrade(const Position& pos, uint16_t itemid,
...
void ProtocolGame81::sendLookInTrade(bool inMyOffer, uint8_t index)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendAcceptTrade()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x7F);
}

void ProtocolGame81::sendRejectTrade()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x80);
}

void ProtocolGame81::sendUseItem(const Position& pos, uint16_t itemid,
			uint8_t stackpos)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendUseItemWith(const Position& fromPos, uint16_t fromItemid,
...
void ProtocolGame81::sendUseBattleWindow(const Position& pos, uint16_t itemid,
...
void ProtocolGame81::sendRotateItem(const Position& pos, uint16_t itemid,
			uint8_t stackpos)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendCloseContainer(uint8_t containerIndex)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendUpContainer(uint8_t containerIndex)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendTextWindow(uint32_t windowId, const std::string& text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendHouseWindow(uint32_t windowId, int unk,
...
void ProtocolGame81::sendLookItem(const Position& pos, uint16_t itemid,
			uint8_t stackpos)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendSay(SpeakClasses_t type, const std::string text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendSay(SpeakClasses_t type, uint16_t channel,
			const std::string text)
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x96);
...
void ProtocolGame81::sendSay(SpeakClasses_t type, const std::string& sendToplayer,
			const std::string text)
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x96);
...
void ProtocolGame81::sendRequestChannels()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x97);
}

void ProtocolGame81::sendOpenChannel(uint16_t channelid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendCloseChannel(uint16_t channelid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendOpenPrivatePlayerChat(const std::string& playerName)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendOpenRuleViolation(const std::string& text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendCloseRuleViolation(const std::string& text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendCancelRuleViolation()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x9D);
}

void ProtocolGame81::sendFightModes(uint8_t attack, uint8_t chase, uint8_t secure)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendAttackCreature(uint32_t creatureid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendFollowCreature(uint32_t creatureid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendCreatePrivateChatChannel()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0xAA);
}

void ProtocolGame81::sendInvitePrivateChatChannel(const std::string& name)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendExcludePrivateChatChannel(const std::string& name)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendInviteParty(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendJoinParty(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendCancelInviteParty(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendPassParyLeader(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendLeaveParty()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0xA7);
}

void ProtocolGame81::sendCancelMove()
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendRequestOutfit()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0xD2);
}

void ProtocolGame81::sendSetOutfit(uint16_t looktype, uint8_t head, uint8_t body,
...
void ProtocolGame81::sendAddVip(const std::string& name)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendRemVip(uint32_t playerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendBugReport(const std::string& text)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendRequestQuestLog()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0xF0);
}

void ProtocolGame81::sendRequestQuest(uint16_t questid)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
//protected
void ProtocolGame81::sendPing()
{
	PROTOCOLGAME_SEND_FUNCTION;
	m_outputMessage.addMessageType(0x1E);
}

void ProtocolGame81::sendRequestUpdateTile(const Position& pos)
{
	PROTOCOLGAME_SEND_FUNCTION;
...
void ProtocolGame81::sendRequestUpdateContainer(uint8_t containerid)
{
	PROTOCOLGAME_SEND_FUNCTION;
