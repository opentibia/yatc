...
#ifndef __PROTOCOLGAME78_H
#define __PROTOCOLGAME78_H
...
class ProtocolGame78 : public ProtocolGame
{
	public:
		virtual ~ProtocolGame78();
	...
	protected:
		ProtocolGame78(const std::string& accountname, const std::string& password, const std::string& name, bool isGM);
