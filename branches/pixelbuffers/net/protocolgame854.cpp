...
ProtocolGame854::~ProtocolGame854()
{
	//
}

void ProtocolGame854::checkVersion()
{
	ASSERT(ProtocolConfig::getInstance().getClientVersion() == CLIENT_VERSION_854);
}
...
bool ProtocolGame854::parsePacket(uint8_t cmd, NetworkMessage& msg)
{
...
void ProtocolGame854::onConnect()
{
